...
#doas xbps-install -S -y fastfetch simple-scan thunderbird audacious gimp transmission-gtk rpi-imager firefox gwenview kate kdenlive yt-dlp xfburn audacity inkscape lutris kitty gnome-boxes bluez bluez-alsa blueman bluez-deprecated wireplumber libspa-bluetooth;
